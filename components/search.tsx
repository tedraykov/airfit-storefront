...
const SORT = {
  'trending-desc': 'Популярни',
  'latest-desc': 'Най-нови',
            ...
            <div className="mb-12 transition ease-in duration-75">
              {data ? (
                <>
                  ...
                  >
                    {data.products.length} резултата{' '}
                    {q && (
                      <>
                        for "<strong>{q}</strong>"
                      </>
                  ...
                  >
                    {q ? (
                      <>
                        Няма намерени продукти, които да включват "
                        <strong>{q}</strong>"
                      </>
                    ) : (
            ...
            <div className="lg:hidden">
              <span className="rounded-md shadow-sm">
                <button
                  ...
                  aria-expanded="true"
                >
                  {sort ? SORT[sort as keyof typeof SORT] : 'По съвпадение'}
                  <svg
                    className="-mr-1 ml-2 h-5 w-5"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
